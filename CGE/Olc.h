...
public:
	...
	//x
	virtual void Draw(int x, int y, short c = 0x2588, short col = 0x000F)//x
	{
	...
	//x
	void Fill(int x1, int y1, int x2, int y2, short c = 0x2588, short col = 0x000F) //x
	{
		Clip(x1, y1);
		Clip(x2, y2);
		for (int x = x1; x < x2; x++)
	...
	//x
	void DrawString(int x, int y, std::wstring c, short col = 0x000F)//x
	{
	...
	//x
	void DrawLine(int x1, int y1, int x2, int y2, short c = 0x2588, short col = 0x000F) //x
	{
